...
veloxminiapp:
	$(MAKE) cmake BUILD_DIR=release BUILD_TYPE=Release EXTRA_CMAKE_FLAGS="${EXTRA_CMAKE_FLAGS} -DVELOX_ENABLE_PARQUET=ON"
	BUILD_DIR=release cmake --build $(BUILD_BASE_DIR)/$(BUILD_DIR) --target=velox_mini_app -j $(NUM_THREADS) 
